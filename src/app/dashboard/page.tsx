      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="p-6 min-h-[400px]">
            ...
            {/* ════ Verified Claims & Un-Claim Tab (البطاقات الموثقة والمعتمدة) ════ */}
                      ...
                      >
                        <div className="space-y-1.5">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-[10px] bg-emerald-100 dark:bg-emerald-500/20 text-emerald-700 dark:text-emerald-200 px-2 py-0.5 rounded-full border border-emerald-500/40 font-bold flex items-center gap-1">
