      ...
      if (action === 'approve') {
        ...
        if (claimingUser && claimingUser.email) {
          ...
          await sendEmailNotification({
            ...
            actionUrl: `${process.env.NEXT_PUBLIC_APP_URL || 'https://family-tree-ten-blush.vercel.app'}/my-tree`,
        ...
        if (claimingUser && claimingUser.email) {
          await sendEmailNotification({
            ...
            actionUrl: `${process.env.NEXT_PUBLIC_APP_URL || 'https://family-tree-ten-blush.vercel.app'}/`,
